package com.keesail.order.common.config;
 ...
 *
 *
 * spring.datasource.url=jdbc:mysql://124.205.196.138:12139/cct_orders?useUnicode=true&characterEncoding=utf8&useSSL=false
 * spring.datasource.username=root
 * spring.datasource.password=keesaildb
...
//        servletRegistrationBean.addInitParameter("deny", "192.168.0.151");
        //登录查看信息的账号密码.
        servletRegistrationBean.addInitParameter("loginUsername", "keesail");
        servletRegistrationBean.addInitParameter("loginPassword", "keesail");
        //是否能够重置数据.
